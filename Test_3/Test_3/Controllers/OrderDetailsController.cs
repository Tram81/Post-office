...
namespace Test_3.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailsID,OrderID,ProductID,Quantity,Price")] OrderDetails orderDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailsID,OrderID,ProductID,Quantity,Price")] OrderDetails orderDetails)
        {
