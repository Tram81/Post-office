...
namespace Test_3.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdminId,AdminName,Password,Email")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,AdminName,Password,Email")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
